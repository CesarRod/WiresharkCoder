...
public class Main extends javax.swing.JFrame {
     ...
     */
    Image image = Toolkit.getDefaultToolkit().getImage(getClass().getResource("tiburon.png"));
    ...
    private void initComponents() {
        ...
        setTitle("Wireshark Coder");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setIconImage(image);

        jLabel1.setText("Datos de Datagrama");

        entrada.setBackground(new java.awt.Color(255, 102, 102));
        entrada.setColumns(20);
        entrada.setRows(5);
        jScrollPane1.setViewportView(entrada);

        salida.setEditable(false);
        salida.setBackground(new java.awt.Color(153, 255, 153));
        salida.setColumns(20);
        salida.setRows(5);
        jScrollPane2.setViewportView(salida);

        boton1.setText("Traducir");
    ...
    private void boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton1ActionPerformed
        if (entrada.getText() != null) {
            WiresharkCoder a = new WiresharkCoder(entrada.getText());
            salida.setText(a.traductor());
        }else{
